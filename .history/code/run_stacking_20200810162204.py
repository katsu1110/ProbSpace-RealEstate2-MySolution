...
# prediction data
oof = {
    'lgb': np.log1p(np.load(OUTPUT_DIR + 'oof_lgb.npy')),
    'xgb': np.log1p(np.load(OUTPUT_DIR + 'oof_xgb.npy')),
    'catb': np.log1p(np.load(OUTPUT_DIR + 'oof_catb.npy')),
    'mlp': np.log1p(np.load(OUTPUT_DIR + 'oof_nn.npy')),
}
